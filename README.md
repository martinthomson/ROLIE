...
list and review the [MILE Working Group](https://datatracker.ietf.org/wg/mile/charter/). If you're
...
sending an e-mail to mile@ietf.org (https://www.ietf.org/mailman/listinfo/MILE). This will ensure that
